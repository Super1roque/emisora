        ...
        <button
          onClick={async () => {
            if (typeof navigator !== 'undefined' && navigator.share) {
              try { await navigator.share({ title: 'Covers', text: 'Escucha covers de tus canciones favoritas', url: window.location.href }); } catch {}
            } else {
              setShareOpen(o => !o);
            }
          }}
        ...
        {shareOpen && (
          <div style={{
            ...
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', padding: '0.75rem 1rem',
                color: 'var(--text)', textDecoration: 'none', fontSize: '0.88rem', borderBottom: '1px solid var(--border)' }}
            >
